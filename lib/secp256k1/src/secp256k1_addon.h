...
class Secp256k1Addon : public Napi::ObjectWrap<Secp256k1Addon> {
 ...
 private:
  ...
  Napi::Value PublicKeyCreateInit(const Napi::CallbackInfo& info);
  Napi::Value PublicKeyCreateFinish(const Napi::CallbackInfo& info);
  Napi::Value PublicKeyCreateFast(const Napi::CallbackInfo& info);
  Napi::Value PublicKeyCreateFastBatch(const Napi::CallbackInfo& info);
